...
export default class SearchPage extends React.Component {
    ...
    render() {
        ...
        if (this.state.hasResult == true) { //有结果就展示
            resultList =
                <div><br/><br/><br/><br/><NewsList listData={listData}></NewsList><br/><br/><br/><br/><br/></div>;
        } else {
            resultList = <div><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
            </div>;
        }
            ...
            <div>
                ...
                <Row>
                    ...
                    <Col span={10}>
                        <div>
                            <br/><br/><br/><br/><br/>
                            <Search placeholder={hintMessage} enterButton="搜索" size="large" onSearch={value => {
